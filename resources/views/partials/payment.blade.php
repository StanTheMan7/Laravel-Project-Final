                        ...
                        <div class="card">
                            <div class="card-header p-0" id="headingTwo">
                                <h2 class="mb-0"> <button class="btn btn-light btn-block text-left collapsed p-3 rounded-0 border-bottom-custom" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <div class="d-flex align-items-center justify-content-between"> <span>Paypal</span> <img src="{{asset('img/payment/paypal.png')}}" width="30"> </div>
                                    </button> </h2>
                            </div>
                            ...
                            <div class="card-header p-0">
                                <h2 class="mb-0"> <button class="btn btn-light btn-block text-left p-3 rounded-0" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                    <div class="d-flex align-items-center justify-content-between"> <span>Credit card</span>
                                        <div class="icons"> <img src="{{asset('img/payment/2ISgYja.png')}}" width="30"> <img src="{{asset('img/payment/visa.png')}}" width="30"> <img src="{{asset('img/payment/stripe.png')}}" width="30"> <img src="{{asset('img/payment/master.png')}}"> </div>
                                    </div>
                                    </button> </h2>
                            </div>
            ...
            <div class="col-md-6"> <span>Summary</span>
                <div class="card">
                    <div class="d-flex justify-content-between p-5">
                        <div class="d-flex flex-column"> <span>{{$pricing->package }}<i class="fa fa-caret-down"></i></span></div>
                        <div class="mt-3"> <sup class="super-price">{{$pricing->price}}</sup> <span class="super-month">/Month</span> </div>
                    </div>
                    <hr class="mt-0 line">
                    <div class="p-3 d-flex justify-content-between">
                        <div class="d-flex flex-column"> <span>Total price you pay (US Dollars)</span> <small>{{$pricing->price}}</small> </div> <span>{{$pricing->price}}</span>
                    </div>
                    <div class="p-3"> <button class="btn btn-primary btn-block free-button">Pay Here</button>

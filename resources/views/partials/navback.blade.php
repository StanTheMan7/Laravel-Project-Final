<div class="sidebar">
    <div class="logo-details">
        <div class="logo_name"><a href="{{route('home')}}">Home</a></div>
    ...
    <ul class="nav-list ">
        ...
        <li>
            <a href="{{route('background.index')}}" class="text-light">
                <i class='bx bx-images'></i>
                <span class="links_name">Background Sliders</span>
            </a>
            <span class="tooltip">Background Sliders</span>
        </li>

        <li>
            <a href="{{route('about.index')}}" class="text-light">
                <i class='bx bx-user-pin'></i>
        ...
        <li>
            <a href="{{route('classe.index')}}" class="text-light">
        ...
        <li>
        <a href="{{route('trainer.index')}}" class="text-light">
            <i class='bx bx-run' ></i>
